  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto">
        ...
        <Link 
          to="/" 
          className="inline-flex items-center justify-center px-8 py-3 rounded-md font-['Orbitron'] bg-gradient-to-r from-cyan-400 to-white hover:from-white hover:to-cyan-400 text-black font-bold transition-all duration-300 transform hover:scale-105 shadow-lg shadow-cyan-500/25"
        >
