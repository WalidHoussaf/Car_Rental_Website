            ...
            <div className="overflow-x-auto rounded-lg border border-cyan-900/30">
              <table className="min-w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-cyan-900/30">
                  {loading ? (
                    <tr><td className="py-6 text-center text-gray-400" colSpan={6}>{t('loadingGeneric')}</td></tr>
                  ) : error ? (
                    <tr><td className="py-6 text-center text-red-300" colSpan={6}>{error}</td></tr>
                  ) : bookings.length === 0 ? (
                    <tr><td className="py-6 text-center text-gray-400" colSpan={6}>{t('noBookingsFound')}</td></tr>
                  ) : (
