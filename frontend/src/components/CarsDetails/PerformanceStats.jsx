        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="relative group perspective-1000">
            ...
            <div className="text-center p-6 rounded-xl border border-cyan-400 bg-gradient-to-br from-black/90 to-blue-950/40 backdrop-blur-md transform transition-all duration-500 group-hover:scale-[1.03] group-hover:shadow-xl group-hover:shadow-blue-600/30 h-full flex flex-col justify-between group-hover:rotate-y-10">
              ...
              <div className="text-gray-300 font-['Tomorrow'] text-xs tracking-wider">ENGINE</div>
            </div>
          </div>
          ...
          <div className="relative group perspective-1000">
            ...
            <div className="text-center p-6 rounded-xl border border-cyan-400 bg-gradient-to-br from-black/90 to-blue-950/40 backdrop-blur-md transform transition-all duration-500 group-hover:scale-[1.03] group-hover:shadow-xl group-hover:shadow-blue-600/30 h-full flex flex-col justify-between group-hover:rotate-y-10">
              ...
              <div className="text-gray-300 font-['Tomorrow'] text-xs tracking-wider">ACCELERATION</div>
            </div>
          </div>
          ...
          <div className="relative group perspective-1000">
            ...
            <div className="text-center p-6 rounded-xl border border-cyan-400 bg-gradient-to-br from-black/90 to-blue-950/40 backdrop-blur-md transform transition-all duration-500 group-hover:scale-[1.03] group-hover:shadow-xl group-hover:shadow-blue-600/30 h-full flex flex-col justify-between group-hover:rotate-y-10">
             ...
             <div className="text-gray-300 font-['Tomorrow'] text-xs tracking-wider">HORSEPOWER</div>
            </div>
          </div>
          ...
          <div className="relative group perspective-1000">
            ...
            <div className="text-center p-6 rounded-xl border border-cyan-400 bg-gradient-to-br from-black/90 to-blue-950/40 backdrop-blur-md transform transition-all duration-500 group-hover:scale-[1.03] group-hover:shadow-xl group-hover:shadow-blue-600/30 h-full flex flex-col justify-between group-hover:rotate-y-10">
              ...
              <div className="text-gray-300 font-['Tomorrow'] text-xs tracking-wider">FUEL ECONOMY</div>
            </div>
          </div>
        </div>
      </div>
