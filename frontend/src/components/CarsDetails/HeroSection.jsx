                    ...
                    <div className="flex items-center space-x-1">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <svg 
                          ...
                          className={`h-4 w-4 ${star <= Math.floor(car.rating || 0) ? "text-yellow-400" : star <= (car.rating || 0) ? "text-gradient-to-r from-yellow-400 to-gray-400" : "text-gray-500"}`}
                          viewBox="0 0 20 20" 
                          fill="currentColor"
                        >
                      ...
                      <span className="font-['Rationale'] ml-1 text-gray-300">{car.rating ? car.rating.toFixed(1) : 'N/A'}</span>
                    </div>
                  </div>
                </div>
              </div>
