  ...
  return (
    <section className="relative py-24 px-4 bg-black overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <h2 className="text-2xl md:text-5xl font-semibold text-center mb-8 text-transparent bg-clip-text bg-gradient-to-r from-white to-cyan-400 font-['Orbitron'] leading-[1.2]">
          Stay Connected
        </h2>
        
        <p className="text-gray-300 mb-12 max-w-2xl mx-auto text-center font-['Orbitron'] text-sm md:text-base">
          Subscribe to receive exclusive offers, new vehicle alerts, and futuristic travel insights directly to your neural interface.
        </p>
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          <form className="relative flex flex-col sm:flex-row gap-4 justify-center bg-black/50 p-2 rounded-lg backdrop-blur-sm border border-gray-800">
            <input
              type="email"
              placeholder="Your email address"
              className="px-6 py-4 rounded-md bg-black/80 border border-gray-700 text-white w-full flex-grow focus:outline-none focus:border-blue-500 transition-all duration-300 font-['Orbitron'] text-2xs placeholder:text-gray-500"
            />
            <button
              type="submit"
              className="group relative px-6 py-4 bg-gradient-to-r from-cyan-400 to-white text-black font-medium rounded-md transition-all duration-300 transform hover:scale-105 overflow-hidden font-['Orbitron'] cursor-pointer" // Added cursor-pointer
            >
              {/* Button Glow Effect */}
        ...
        <p className="text-gray-500 text-sm text-center mt-6 font-['Orbitron']">
          Your data is encrypted with quantum cryptography. We respect your privacy.
        </p>
      </div>
    </section>
  );
