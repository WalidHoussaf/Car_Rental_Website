  ...
  return (
    <div className="mb-6 p-5 bg-gray-900 rounded-xl shadow-lg">
      <label className="text-xs font-semibold text-gray-300 mb-3 flex items-center font-['Orbitron']">
        ...
        Price Range: <span className="ml-1 text-cyan-400">${filters.priceRange[0]}</span> - <span className="text-gray-300">${filters.priceRange[1]}</span>
      </label>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div>
          ...
          <div className="relative h-2 bg-gray-700 rounded">
            ...
            />
            <div 
              className="absolute left-0 transform -translate-x-1/2 top-1/2 -translate-y-1/2 w-4 h-4 bg-cyan-400 shadow-lg rounded-full animate-pulse cursor-pointer z-20" 
              style={{ left: `${(filters.priceRange[0] / 1000) * 100}%` }}
            ></div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative h-2 bg-gray-700 rounded">
            ...
            />
            <div 
              className="absolute left-0 transform -translate-x-1/2 top-1/2 -translate-y-1/2 w-4 h-4 bg-gray-300 shadow-lg rounded-full animate-pulse cursor-pointer z-20" 
              style={{ left: `${(filters.priceRange[1] / 1000) * 100}%` }}
            ></div>
          </div>
        </div>
      </div>
